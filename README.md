...
Every feature suggestion and hypothesis put through the bar — 29 verified, 16 unfinished, 27 declined. Typed in `config/hypotheses.tsv`; this table and the app's Patches page both render from it, so they cannot disagree.
