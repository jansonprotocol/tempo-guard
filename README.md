...
## CURRENT CONFIRMED HITRATE: 84.9%
    ...
    placed bets             48 / 57   84.2%    ROI +6.1%
...
**Settled: 48 / 57  ·  ROI +6.1%  ·  flat stakes** — settled through real settlement fractions by the ledger; a push or half-win counts as a hit, a half-loss does not. Notes travel with the bet in `config/bets.tsv`.
