...
class TeamAdmin(ModelView, model=Team):
    ...
    # No aliases in form — use /admin/manage-aliases instead (link shown in list)
...
<body>
  ...
  <script>
    ...
    function loadAliases() {
      fetch(`/admin/alias-api/team/${currentTeamId}/aliases`)
        .then(r => r.json())
        .then(data => {
    ...
    function deleteAlias(aliasId) {
      fetch(`/admin/alias-api/alias/${aliasId}`, { method: 'DELETE' })
        .then(r => r.json())
        .then(data => {
          const msg = document.getElementById('msg');
          if (data.error) {
...
def setup_admin(app: FastAPI):
    ...
    @app.get("/admin/alias-api/team/{team_id}/aliases")
    ...
    @app.post("/admin/alias-api/team/{team_id}/aliases")
    ...
    @app.delete("/admin/alias-api/alias/{alias_id}")
