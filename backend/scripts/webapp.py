...
SESSIONS = [
    dict(name="The cup run", dates="24–27 Aug 2026",
         nums=[("Tip 1", "56/68 · 82.4%"), ("Tip 2", "38/54 · 70.4%"),
               ("Playable", "40/47 · 85.1%"), ("Bets", "24/34 · ROI −8.6%")],
         patches=["Cups reopened on the probationary Club Elo lane and "
                  ...
                  "Closed at 82.4% tips / −8.6% ROI: the gap between "
...
<section class="page about" id="p-about">
 ...
 <div class="runs">
  ...
  <div class="run"><b>Session #3 <span class="when">· 24–27 Aug
   ...
   Tip 1 <b>82.4%</b> on 68 settled, found bets <b>−8.6%</b> ROI — the
