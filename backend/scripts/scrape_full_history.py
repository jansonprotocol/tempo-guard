...
from app.services.scrapers.fixture_scraper import update_fixtures_for_league  # FIXED: correct function name
from app.services.scrapers.player_scraper import update_player_stats_for_teams  # FIXED: correct function name
...
def load_league_full_history(league_code: str, headless: bool = False, force: bool = False) -> dict:
    ...
    # update_fixtures_for_league already handles both seasons internally
    try:
    ...
    #    update_player_stats_for_teams with an empty set means "all teams"
